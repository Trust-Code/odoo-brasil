...
try:
    from pytrustnfe.nfse.issnet import xml_recepcionar_lote_rps
    from pytrustnfe.nfse.issnet import recepcionar_lote_rps
    from pytrustnfe.nfse.issnet import consultar_lote_rps
    from pytrustnfe.nfse.issnet import cancelar_nfse
...
class InvoiceEletronic(models.Model):
    ...
    def _find_attachment_ids_email(self):
        ...
        danfe_report = self.env['ir.actions.report'].search(
            [('report_name', '=',
              'br_nfse_issnet.main_template_br_nfse_danfe_issnet')])
    ...
    def action_send_eletronic_invoice(self):
        ...
        if self.model != '006' or self.state in ('done', 'cancel'):
            return
        self.state = 'error'
