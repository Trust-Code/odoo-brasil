...
class AccountInvoice(models.Model):
    ...
    def _prepare_edoc_item_vals(self, invoice_line):
        vals = {
            ...
            'seguro': invoice_line.insurance_value,
            'desconto': invoice_line.discount_value,
            'outras_despesas': invoice_line.other_costs_value,
            'valor_bruto': invoice_line.price_subtotal,
            'valor_liquido': invoice_line.price_subtotal,
            'origem': invoice_line.icms_origin,
            'tributos_estimados': invoice_line.estimated_taxes,
            # - ICMS -
            'icms_cst': invoice_line.icms_cst,
            'icms_aliquota': invoice_line.icms_percent_credit,
            'icms_modalidade_BC': invoice_line.icms_value_credit,
            'icms_base_calculo': invoice_line.icms_value_credit,
            'icms_percentual_reducao_bc': invoice_line.icms_value_credit,
            'icms_valor': invoice_line.icms_value_credit,
            'icms_value_credit': invoice_line.icms_value_credit,
            'icms_value_percentual': invoice_line.icms_value_credit,
            'icms_percentual_mva': invoice_line.icms_value_credit,
            'icms_aliquota_st': invoice_line.icms_value_credit,
            'icms_base_calculo_st': invoice_line.icms_value_credit,
            'icms_percentual_reducao_bc_st': invoice_line.icms_value_credit,
            'icms_valor_st': invoice_line.icms_value_credit,
            'icms_percentual_diferimento': invoice_line.icms_value_credit,
            'icms_valor_diferido': invoice_line.icms_value_credit,
            'icms_motivo_desoneracao': invoice_line.icms_value_credit,
            # - IPI -
