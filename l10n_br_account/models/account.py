...
# 
#     @api.v7
#     def compute_all(self,cr, uid, ids, price_unit, currency_id=None, quantity=1.0,
#                     product_id=None, partner_id=None, context=None,force_excluded=False,
...
#                     product=None, partner=None, context=None, force_excluded=False,
#                     fiscal_position=False, insurance_value=0.0,
#                     freight_value=0.0, other_costs_value=0.0):
#                 
#         precision = self.env['decimal.precision'].precision_get('Account')
#                 
#         result = super(AccountTax, self).compute_all(price_unit, currency, quantity, product, partner)
#         print result
#         totaldc = 0.0
#         calculed_taxes = []
# 
...
#         result_tax = self._compute_tax(common_taxes, result['total_included'],
