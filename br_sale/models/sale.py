...
class SaleOrderLine(models.Model):
    ...
    @api.depends('product_uom_qty', 'discount', 'price_unit', 'tax_id',
                 ...
                 'excluir_difal_pis_cofins', 'icms_aliquota_reducao_base',
                 'icms_st_aliquota_reducao_base', 'ipi_reducao_bc', 'icms_st_aliquota_deducao')
    ...
    @api.depends('cfop_id', 'icms_st_aliquota_mva', 'aliquota_icms_proprio',
                 ...
                 'icms_aliquota_reducao_base', 'tem_difal',
    ...
    def _prepare_invoice_line(self, qty):
        ...
        res['excluir_difal_pis_cofins'] = self.excluir_difal_pis_cofins
