...
class WizardCartaCorrecaoEletronica(models.TransientModel):
    ...
    def send_letter(self):
        ...
        carta = {
            ...
            'CNPJ': re.sub("[^0-9]", "", edoc_id.company_id.cnpj_cpf or ''),
            'cOrgao': edoc_id.company_id.state_id.l10n_br_ibge_code,
            'tpAmb': edoc_id.company_id.tipo_ambiente,
            'estado': edoc_id.company_id.state_id.l10n_br_ibge_code,
        ...
        cert = edoc_id.company_id.with_context({'bin_size': False}).nfe_a1_file
        cert_pfx = base64.decodestring(cert)
        certificado = Certificado(cert_pfx, edoc_id.company_id.nfe_a1_password)
